...
<div class="row">
 ...
 <form name="frm" method="post" action="roqot_suc.php?state=<?php echo $state;?>" enctype="multipart/form-data">
...
<button type="button" class='btn btn-danger delete'>-</button>
                            ...
                            <input type="text" name="pname[]" style="width:100px;" value="<?php echo $rs1['desc1']; ?>">
                                                        </td>
                                                        <td class="hidden-480">
														<input type="text" name="serv_num[]" style="width:100px;" value="<?php echo $rs1['serv_code']; ?>"></td>
                                                    <td class="hidden-480">
														<input type="text" name="brand[]" style="width:100px;" value="<?php echo $rs1['brand']; ?>"></td>
														<td class="hidden-480">
														<input type="text" name="model[]" style="width:100px;" value="<?php echo $rs1['model']; ?>"></td>
														
													
                                                        <td class="hidden-480">
							<input type="text" name="hsn[]" value="<?php echo $rs1['hsn']; ?>" style="width:70px;">
														</td>
														
														  <td class="hidden-480">
							<input type="text" name="gst[]" value="<?php echo $rs1['gst']; ?>" id="gst<?php echo $i?>" style="width:70px;">
														</td>
                                                         <td>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href='roqot_list.php?state=<?php echo $state;?>'<button class="btn btn-danger" type="button" name="button" id="Close">
