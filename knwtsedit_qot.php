...
$("#submit").prop('disabled',true);
 ...
 function testr2(){
   ...
   function testr3(){
	 var adv=document.getElementById('adv_amnt3').value;
	 //alert(adv);
	 if(adv > 0){
	    // alert(adv);
	     var gst=document.getElementById('ac_det4').required='true';
	     //gst.attributes.required = "required";
	 }
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="knqot_list.php"> Quotations List</a>
                            </li>
                            <li>
...
<div class="row">
 ...
 <form name="frm" method="post" action="knwtsqot_suc.php" enctype="multipart/form-data">
 <input type="hidden" name="ids" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
									  ...
									  <th> <input type="text" name="adv_amnt" onkeyup="testr()"
									   ...
									   <tr>
									   <th>4</th>
									   	<td><select name="gst_type3" id="gst_type3" class="form-control" onChange="test3()">
									    <option value="">Select GST</option>
									   ...
									   <td >
										<input type="text" name="adv_amnt3" data-row="2" onkeyup="testr3()"
										id="adv_amnt3"   class="form-control kal" <?php if(($r['adv_amnt3']!='0.00') or ($bal=="0") or ($ystatus=='Pending') ){ echo 'readonly';}else{ echo ''; } ?>    value="<?php echo $r['adv_amnt3'];?>"></td>	
										<td >
										<input type="text" name="gst_amount3" 
										id="gst_amount3" readonly    class="form-control"  value="<?php echo $r['gst_amount3'];?>"></td>	
										
									   <td><input type="date" name="adv_date3" 
										id="sub_type"  class="form-control" <?php if($r['adv_amnt3']!='0.00'){  echo 'type="text"'.'readonly';}else{ echo 'type="date"'; } ?>       value="<?php if($r['adv_amnt3']!='0.00'){ echo  $r['adv_date3'];}else{ echo date('Y-m-d');}?>"></td>
									   
									   
									   <td><input id="ac_det3"  <?php if($r['adv_amnt3']!='0.00'){ echo 'readonly';}else{ echo ''; } ?> class="form-control" name="ac_det4" value="<?php echo $str=$r['ac_det4'];?>"  onkeyup='s2(3)'><div id='suggesstion-box3'></div>
	</td>
									   </tr>
									   </table>
...
<button type="button" class='btn btn-danger delete'>-</button>
                         ...
                         <div class="table-responsive">
											...
											<?php	}else{ ?>
													...
													<a onclick="return confirm('Are you sure you want to delete this item?');" href='delete_knline.php?id=<?php echo $rs1['id']; ?>&id1=<?php echo $rs1['id1'];?>'><input type="button" class="btn btn-danger" value="Delete"></button>
							</a>
							<?php }?>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="knwtsqot_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
