...
$objPHPExcel->getActiveSheet()->mergeCells('A1:U1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'KN REQUEST AMOUNT LIST');
...
while($row	=	$result->fetch_assoc()){
	...
	$tyy="select sum(req_amnt+gstamt) as rsamt from knrequest_amnt where quet_num='$qot' and confirm='Yes'";
