                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#">GST Bills Pending List</a>
                            </li>
...
<div class="row">
             ...
             <div class="col-sm-2"><b><a href="qut_kngst_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
											...
											if(isset($_POST['bsearch'])){
											    ...
											    $y="select * from knrequest_amnt where gsttype='With GST'";
							                	}else { 
							                	    
							                	    if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($name=='knbilling') or ($tsname=='sumanthpotluri')){
												 $y="select * from knrequest_amnt where gsttype='With GST'    ";
							                	    }else{
							                	         $y="select * from knrequest_amnt where gsttype='With GST' and user='$tsname'    ";
							                	    }
											...
											while($rs1=mysqli_fetch_array($t)){
												$q=$rs1['quet_num'];
												//$ramtn
												$r=mysqli_query($link,"select * from add_knqot where quet_num='$q'") or die(mysqli_error($link));
												$r1=mysqli_fetch_array($r);
												$store_code=$r1['store_code'];
											        $nextmonthdate = date('Y-m-d', strtotime('+1 month', strtotime($rs1['transfer_date'])));
...
$currentDateTime = date('Y-m-d');
                                                if(($currentDateTime>$nextmonthdate)){
                                                    $color="red";
                                                    $c1="#fff";
                                                }else{
                                                    $color="";
                                                    ...
                                                    <td><?php echo $i; ?></td>
													  ...
													  ?>
													   <td><?php echo $r1['store_code']; ?> </td>
													    <td><?php echo $r3['store_name']; ?> </td>
													 <td><?php echo $r3['coordinator']; ?> </td>
                                                    <td><?php echo $r3['superwisor']; ?> </td>
												   
												    <td><?php echo $rr=$rs1['req_amnt']+$rs1['gstamt']; ?></td>
                                                       
                                                       <td class="hidden-480"><?php echo $rs1['ac_det'] ?>
														
														</td>
														<td class="hidden-480"><?php echo date('d-m-Y',strtotime($rs1['transfer_date'])) ?>
														
														</td>
                                                      
                                                       
                                                        
                                                        <td class="hidden-480"><?php echo $gstatus=$rs1['gstatus'] ?>
                                                        ...
                                                        <td class="hidden-480">
                                                           <?php  if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($tsname=='sumanthpotluri') ){ ?>
                                                            <a href="knfile_edit.php?id=<?php echo $rs1['id']; ?>">
                                                     ...
                                                     <?php   }
														...
														<td class="hidden-480">
														   <?php   if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($tsname=='sumanthpotluri')){ ?>
														    <a href="knfile_view.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
                                                        
                                                        <?php }else{ ?><img src="images/edit.gif"> <?php }?></td>
                                                    </tr>
											...
											//$ssq=mysqli_query($link,"select * from add_qot where status='Not Required' quet_num='$bsearch'");
											
											
											//} else {
													 $y="select * from add_qot2 where gst_type='With GST'    ";
											//}
											//$t=mysqli_query($link,$y) or die(mysqli_error($link));
											//$j=$k+1;
											//while($rs1=mysqli_fetch_array($t)){
...
echo "<li><a href='knwork2.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='knwork2.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
