...
$bid=$_GET['id'];
$loc=$_GET['loc'];
$q=mysqli_query($link,"select * from add_knbill1 where id='$bid'") or die(mysqli_error($link));
...
<hr></td></tr>
        ...
        <tr><td colspan="8" style="text-align:center;font-size:18px;border:0px;"><b>KN QUOTATIONS LIST</b></td></td></tr>
...
$bid=$r['id'];
	 ...
	 $aa="select * from add_knqot order by id desc ";
