...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                  ...
                  <div class="col-sm-2"><b><a href="qut_knrreqamt_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b>
                                ...
                                <?php         
                                  if(isset($_POST['bsearch'])){
											...
											// $y="select * from add_qot2 where  ro_date='$date'";
												$y="select * from knrequest_amnt where confirm!='Yes' order by id desc";
...
<!--<td class="center">
										...
										$state=$rs1['state'];
										if($state=='KN'){
										 $a="select * from add_knqot where quet_num='$qot' and ro_date='$date'  ";
										} 
										 ...
										 <td><?php echo $i; ?></td>
												 ...
												 <td class="hidden-480"><?php echo $r1['tot_gst']; ?></td>
												  ...
												  ?></td>
                                                       ...
                                                       <td class="hidden-480"><a href="knreq_amnt_list.php?id=<?php echo $rs1['id']; ?>&amt=<?php echo $amt;?>&st=<?php echo $state;?>" onclick="return confirm('are you sure?')">
                                                        <img src="update.png" width="16" height="16"></a></td>
                                                    <td class="hidden-480"><a href="knedit_request.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a>
                                                     
                                                     <a href="kncancel_request.php?id=<?php echo $rs1['id']; ?>">
...
?>
										...
										$state=$rs1['state'];
										if($state=='KN'){
										 $a="select * from add_knqot where quet_num='$qot'";
										} 
										$ssq=mysqli_query($link,$a);
										$r1=mysqli_fetch_array($ssq);
										$str_code=$r1['store_code'];
										...
										?>
												 ...
												 <td class="hidden-480"><?php echo $r1['tot_gst']; ?></td>
												  ...
												  <?php $ree= $rs1['req_amnt']; ?>
												   ...
												   <?php
												             $ty5="select sum(approve_amnt) as samt from knrequest_amnt where quet_num='$qot'";
                                        ...
                                        echo $tadv=$ty15['samt'];
                                                ...
                                                ?>
												    ...
												    <td class="hidden-480">
												        <?php
												             $tyy="select sum(req_amnt+gstamt) as samt from knrequest_amnt where quet_num='$qot' and confirm='Pending'";
                                                            $ty=mysqli_query($link,$tyy) or die(mysqli_error($link));
                                                $ty1=mysqli_fetch_array($ty);
                                        ...
                                        $reqamt=$reqamt+$treq;
                                                ?></td>
												  ...
												  <td class="hidden-480"><?php 
												     ...
												     $yt5="select * from knrequest_amnt where quet_num='$qot'";
