...
include 'PHPExcel-1.8/Classes/PHPExcel/Writer/Excel2007.php';
 $name=$_GET['user'];
//$datatable="add_klqot";
if(($name=='admin') or ($name=='durgarao') or ($name=='accounts') or ($name=='sumanthpotluri') or ($name=='Muhammed Bafakhi')or ($tsname=='knbilling') ){
...
$objPHPExcel->getActiveSheet()->mergeCells('A1:L1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'KARNATAKA  QUOTATION  GST FILES LIST');
...
header('Content-Disposition: attachment;filename="kngstlist.xlsx"'); //tell browser what's the file name
