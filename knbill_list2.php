...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
                                    ...
                                    KN To be raised Invoice List
                                        ...
                                        <div class="col-sm-12"><a href="addkninvoice.php"><button class="btn btn-primary btn-xs">Add New Invoice </button></a></div>
                ...
                <input type="text" class="form-control pull-right" id="myInput" name="search" placeholder="Search   " onkeyup="myFunction()">
                  ...
                  <div class="col-sm-2"><b><a href="qut_knrasise_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div style="overflow-x:auto;">
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="SELECT * FROM knqot_bill where status='payment pending'  and quet_num like  '%$bsearch%'  ";
											} else {
                                            ...
                                            $df=$diff->format("%a");
                                                if($df > 7){
													...
													$ssq=mysqli_query($link,"select * from knrequest_amnt where quet_num='$q'");
...
<!--<td class="center">
													  ...
													  $ssq1=mysqli_query($link,"select * from add_knqot where quet_num='$q'");
