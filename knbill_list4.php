               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                   ...
                                   <div style="overflow-x:auto;">     
											...
											while($rs1=mysqli_fetch_array($t)){
													...
													$q=$rs1['inv_no'];
													$st=$rs1['state'];
													$yu=mysqli_query($link,"select inv_date,inv_sub_date,speriod,ftype,sum(gst28) as gst28,sum(gst18) as gst18,sum(gst12) as gst12,sum(gst5) as gst5,sum(gst5) as gst5,sum(tbase) as tbase from knqot_bill where inv_num='$q'") or die(mysqli_error($link));
                                                    ...
                                                    <tr>
                                                     ...
                                                     <td class="hidden-480">
                                                        ...
                                                        <td><?php echo $rs1['user']; ?></td>
														 <td class="hidden-480">
                                                        <a href="knedit_paymentrecv.php?id=<?php echo $rs1['id'];?>"><img src="images/edit.gif"/></a>
                                                        </td>	
                                                        <td>
														    <?php
														    
														    
														    $tp=mysqli_query($link,"select file from knqot_bill where inv_num='$q'") or die(mysqli_error($link));
														    ...
														    <td><a href="kndelete_recv.php?id=<?php echo $rs1['id']; ?>"><img src="images/Icon_Delete.png"/></a></td>
                                                    </tr>
