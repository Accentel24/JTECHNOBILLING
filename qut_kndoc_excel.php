...
$objPHPExcel->getActiveSheet()->mergeCells('A1:R1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'KARNATAKA DOCUMENT REQUIRED LIST');
...
while($row	=	$result->fetch_assoc()){
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('S'.$rowCount, mb_strtoupper($row['user'],'UTF-8'));
	$rowCount++;
$i++; }
