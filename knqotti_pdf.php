...
<div class="noBorder" ><th   colspan="14"style="border-right:none !important;font-size:18px;">
			<img src="images/excel_logo.jpg" height="100"/></div>
...
<div style="border:1px solid #000;">
 <table >
		...
		<?php echo $r1['address'];?><br/>
				<?php echo  $st=$r1['state']; if($st=='KN'){ echo "KARNATAKA "; } else if($st=='TN'){ echo "TAMILNADU"; }?><br/>
			<?php echo $r1['gst_in'];?>
			</b>
...
$bid=$r['id'];
	 ...
	 $aa="select * from add_knqot1 where  id1='$bid' ";
...
echo  "<script type=\"text/javascript\"> 
   ...
   setTimeout(\"DoTheRedirect('knbill_list31.php')\",parseInt(2*1000));
