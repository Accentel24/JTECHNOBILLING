                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">Work To Be Started List</a>
                            </li>
                        ...
                        <!-- PAGE CONTENT BEGINS -->
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                        ...
                                        Work To Be Started Quotations List
                                        </div>
...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
                ...
                <input type="text" class="form-control pull-right" id="" name="search" onkeyup="myFunction()" placeholder="Search By Quotation No  or FM Fault No or status">
                  </div>
				   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_knwts_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
echo "<li><a href='knwtsqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='knwtsqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
