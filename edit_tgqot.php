        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <div class="main-content">
                <div class="main-content-inner">
                 ...
                 <?php  $id=$_GET['id'];
						$sq=mysqli_query($link,"select * from add_tgqot where id='$id'");
...
<div class="row">
 ...
 <form name="frm" method="post" action="tgqot_suc.php" enctype="multipart/form-data">
...
?>
										...
										<img src="upload/<?php echo $r['img1'];?>"  onclick="window.open('qut_image.php?id=<?php echo $r['img1'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
										<td align="right">Image2</td><td align="left">
										<input type="file" name="imagea">
										<img src="upload/<?php echo $r['img2'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img2'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                        </tr>
										<tr>	
                                        <td align="right">Image3 </td><td>
										<input type="file" name="imageb">
										<img src="upload/<?php echo $r['img3'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img3'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
                                        </tr>
                                    <tr><td colspan="2"><b>After Images</b></td></tr>
										...
										<img src="upload/<?php echo $r['img4'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img4'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
										<td align="right">Image5</td><td align="left">
										<input type="file" name="image5">
										<img src="upload/<?php echo $r['img5'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img5'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;"></td>
                                        </tr>
										<tr>	
                                        <td align="right">Image6 </td><td>
										<input type="file" name="image6">
										<img src="upload/<?php echo $r['img6'];?>" onclick="window.open('qut_image.php?id=<?php echo $r['img6'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" style="width:50px; height:50px;">
										</td>
                                        </tr>
...
<button type="button" class='btn btn-danger delete'>-</button>
 ...
 <tr><td colspan="3"><a onclick="window.open('adduitems.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" >Add Items</a></td>
 <td colspan="8"><b style="color:red;">for getting the values after selecting the description column please click on descripton text box once</b></td>
 </tr>
											...
											<?php   $id=count($_POST['id']);
											 $id1=$_GET['id'];
											 $aa="select * from add_tgqot1 where id1='$id1'";
                            ...
                            <input type="text" name="pname[]" id="pname<?php echo $i ?>" data-row="<?php echo $i ?>" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> style="width:100px;" value="<?php echo $rs1['desc1']; ?>" onchange='showUser(this.value,<?php echo $i ?>)'>
                                                        </td>
							...
							<input type="text" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> name="hsn[]" value="<?php echo $rs1['hsn']; ?>" style="width:70px;">
														  ...
														  <td class="hidden-480">
							<input type="text" name="gst[]" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> data-row="<?php echo $i ?>" value="<?php echo $rs1['gst']; ?>" id="gst<?php echo $i?>" style="width:70px;">
														</td>
                                                         <td>
							<input type="text" name="uom[]" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> data-row="<?php echo $i ?>" value="<?php echo $rs1['uom']; ?>" style="width:60px;" data-row="<?php echo $i?>" class=""  /> 
														</td>
														 <td class="hidden-480">
                            <input type="text" name="price[]" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> id="price<?php echo $i?>" style="width:70px;" data-row="<?php echo $i?>" value="<?php echo $rs1['rate']; ?>"   />
                                                        ...
                                                        <td>
							<input type="text" name="qty[]" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?>  onkeyup='qval(this.value,<?php echo $i ?>)' value="<?php echo $rs1['qty']; ?>" class="txt1" style="width:60px;" data-row="<?php echo $i?>"  id="qty<?php echo $i?>"  /> 
														</td>
						...
						<input type="text" name="serv_amt[]" value="<?php echo $rs1['serv_fee']; ?>" readonly style="width:60px;" class="txt21" data-row="<?php echo $i?>"    id="serv_amt<?php echo $i?>" />
                    									...
                    									<td class="hidden-480">
														<input type="text" name="remarks[]" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> style="width:100px;" value="<?php echo $rs1['remarks']; ?>"></td>
                                                       <td>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>"  style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="tgqot_list.php"><button class="btn btn-danger" type="button" name="button" id="Close">
