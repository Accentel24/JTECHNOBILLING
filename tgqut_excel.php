...
$objPHPExcel = PHPExcel_IOFactory::load("qutoationtemplate.xlsx");
$id=$_GET['id'];
...
$objPHPExcel->getActiveSheet()->setCellValue('c4', $state1);
...
$aa="select count(base_amt) as counti  ,sum(base_amt) as base ,sum(serv_amt) as serv,sum(base_amt+serv_amt) as total,sum(gst_amnt) as gst from add_tgqot1 where  id1='$bid' ";
