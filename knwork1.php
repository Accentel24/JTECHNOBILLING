                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="#">KN Mark Not Required Bills  List</a>
                            </li>
...
<div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                     ...
                                     KN Mark Not Required Bills  List
                                        </div>
             ...
             <div class="col-sm-2"><b><a href="qut_knmark_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
            	</div>
											...
											while($rs1=mysqli_fetch_array($t)){
											    $quet_num=$rs1['quet_num'];
											$yu=mysqli_query($link,"select * from add_knqot where quet_num='$quet_num'") or die(mysqli_error($link));
											$yu1=mysqli_fetch_array($yu);
													
													
													$store_code=$yu1['store_code'];
...
<!--<td class="center">
													  ...
													  ?>
													   <td><?php echo $yu1['store_code']; ?> </td>
													    <td><?php echo $r3['store_name']; ?> </td>
													 <td><?php echo $r3['coordinator']; ?> </td>
                                                    <td><?php echo $r3['superwisor']; ?> </td>
                                                     <td><?php 
                                                     $uy=mysqli_query($link,"select sum(approve_amnt) as amt from knrequest_amnt where quet_num='$quet_num'") or die(mysqli_error($link));
                                                     $uy1=mysqli_fetch_array($uy);
                                                     
                                                     
                                                     echo $uy1['amt']; ?> </td>
                                                     
                                                     <th><?php echo $rs1['note']; ?></th>
												        <td class="hidden-480"><?php echo $rs1['docr_status'] ?>
														</td>
                                                        ...
                                                        <td><a href="kndcrfile_view.php?id=<?php echo $rs1['id'] ?>">View Fiie</a></td>
