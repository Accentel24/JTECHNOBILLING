...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_knro_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
<?php  
$sql="SELECT distinct store_code FROM add_knqot";
...
<?php  
$sql="SELECT distinct a.store_name FROM add_knqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct a.coordinator FROM add_knqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct a.superwisor FROM add_knqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct a.city FROM add_knqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
<?php  
$sql="SELECT distinct status FROM add_knqot ";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
echo "</datalist>";?></datalist></th>
													 ...
													 <th><input type="submit" value="Submit" name="submitkk" class="btn btn-primary" ></th>
														 <th>   <input type="reset" value="Reset" name="submit1" class="btn btn-danger"  onclick="javascript:location.href='knqot_list.php'"> </th>
			 </th> <th></th><th></th>
														 <th></th>
                                                         <th></th>
                                                       <th></th>
...
$start_from = ($page-1) * $results_per_page;
											...
											// $y="select a.store_name,a.city,b.quet_num,b.store_code,b.inv_date,b.id
											 ...
											 $y="select * from add_knqot where quet_num like '%$bsearch%' or falt_no like '%$bsearch%'  or status like '%$bsearch%'order by id desc";
												} else
...
$r1=mysqli_fetch_array($ssq1);
                                                    ...
                                                    <td class="hidden-480"><a href="knroedit_qot.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/edit.gif"></a></td>
														 <td class="hidden-480"><a onclick="return confirm('Are you sure you want to send the Email?');" href="knqotpdfcheck.php?id=<?php echo $rs1['id'];?>&name1=<?php echo $r1['coordinator'];?>&name2=<?php echo $r1['superwisor'];?>"
												   class="">
                                                        <img src="images/email.png" width="20" height="20"></a></td>
														
														 <td class="hidden-480">
														 
                                                   <a onclick="window.open('knqut_print.php?id=<?php echo $rs1['id'];?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"
												   class="btn btn-primary btn-xs"><img src="images/printer.png"></a>
                                                        </td> 
                                                        
                                                         <td class="hidden-480"><a href="knqut_excel.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                        <td class="hidden-480"><a href="knqut_excel_bill.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                     <td class="hidden-480"><a href="knqut_excel_mis.php?id=<?php echo $rs1['id']; ?>">
                                                        <img src="images/xl.jpg" width="20" height="20"></a></td>
                                                       </td> <td class="hidden-480">
                                                       <a href="knqot_pdf.php?id=<?php echo $rs1['id'];?>"
...
echo "<li><a href='knroqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='knroqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
