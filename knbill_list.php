                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">KN Document Required List</a>
                            </li>
                            <li>
...
<div class="row">
                ...
                <input type="text" class="form-control pull-right" id="myInput" onkeyup="myFunction()" name="search" placeholder="Search  ">
                  ...
                  <div class="col-sm-2"><b><a href="qut_kndoc_excel.php?user=<?php echo $tsname ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
			<!--	   <div class="col-sm-3">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                                        ...
                                        <div style="overflow-x:auto;">
											...
											if(isset($_POST['bsearch'])){
											 ...
											 $y="SELECT distinct quet_num,state,transfer_date,user FROM `knrequest_amnt`  where status='Amount Transferred' and bill_status='' and  quet_num like  '%$bsearch%'  ";
											} else {
										...
										if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts') or ($tsname=='klbilling') or ($tsname=='sumanthpotluri')or ($tsname=='knbilling')or ($tsname=='naiduys')){
											...
											while($rs1=mysqli_fetch_array($t)){
											    $ses=$rs1['user'];
											    	$qtno=$rs1['quet_num'];
											    $yt=mysqli_query($link,"select transfer_date from knrequest_amnt where quet_num='$qtno'");
						...
						$a="select store_code,ro_no,po_no,ro_date,falt_desc,id,tot_base,tot_ser,tot_gst,net from add_knqot where quet_num='$qtno'";
...
<!--<td class="center">
                                                      ...
                                                      <td class="hidden-480"><?php echo $r3['superwisor']; ?></td>
														 ...
														 <td class="hidden-480"><?php echo $r1['po_no']; ?></td>
									 ...
									 $ac=$rs1['ac_det'];
									 $a="select ac_det,approve_amnt,transfer_date from knrequest_amnt where quet_num='$qtno' and  confirm='Yes' ";
...
<?php
														...
														$a1="select transfer_date  from knrequest_amnt where quet_num='$qtno' and  confirm='Yes' order by id desc limit 1 ";
