...
<button type="button" class='btn btn-danger delete'>-</button>
  ...
  <tr><td colspan="3"><a onclick="window.open('addkuitems.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" >Add Items</a></td>
											...
											<?php   $id=count($_POST['id']);
											 $id1=$_GET['id'];
											 $aa="select * from add_knqot1 where id1='$id1'";
												...
												<?php if($rono!=' '){ ?>
													<a onclick="return confirm('Are you sure you want to delete this item?');" href='delete_knline.php?id=<?php echo $rs1['id']; ?>&id1=<?php echo $rs1['id1'];?>'><input type="button" class="btn btn-danger" value="Delete"></button></a>
                            ...
                            <select type="text" name="productype[]" <?php if($rono!=''){ echo 'readonly'; }else { echo '';} ?> style="width:100px;" >
                                <option value="plumbing" <?php if($rs1['productype']=='plumbing') echo 'selected';?> >Plumbing</option><option value="carpentory" <?php if($rs1['productype']=='carpentory') echo 'selected';?> >Carpentory</option><option <?php if($rs1['productype']=='electrical') echo 'selected';?> value="electrical">Electrical</option><option selected value="service" <?php if($rs1['productype']=='service') echo 'selected';?> >Service</option>
                                </select>
                                                        </td>
						...
						<input type="hidden" name="serv_code[]" value="<?php echo $rs1['serv_cap']; ?>" style="width:50px;" class="" id="serv_code<?php echo $i?>" />	   
													   ...
													   <!-- <td>
						<input type="hidden" name="product_code[]" value="<?php echo $rs1['product_code']; ?>" style="width:50px;" class="" id="product_code<?php echo $i?>" />	   
													   </td> -->
									...
									<td><input style="width:60px;" type="text" readonly placeholder="Total Serv" name="tot_serv" class="txt5" value="<?php echo $r['tot_ser'];?>" id="tot_serv" />+
										...
										<?php }?>
											...
											&nbsp; &nbsp; &nbsp;
                                           <a href="qot_knlist.php"><button class="btn btn-danger" type="button" name="button" id="Close">
...
data +="<td><input type='text' name='model[]' required data-row='"+i+"' value='' style='width:60px;'  class='' id='model"+i+"' /> </td>";                   
	...
	data +="<td><input type='text' name='price[]'  data-row='"+i+"' id='price"+i+"' style='width:70px;' value='' class='txt1 '  /></td>";
	 data +="<td><input type='text' name='qty[]'  data-row='"+i+"' value='' style='width:60px;' class=' ' id='qty"+i+"' onkeyup='qval(this.value,"+i+")' /> </td>"; 
...
data +="<td><input type='text' name='amnt[]' data-row='"+i+"' value='' style='width:60px;' readonly class='txt tx6' id='amnt"+i+"' /> </td>";          
   ...
   data +="<td><input type='text' name='gst_amnt[]' data-row='"+i+"' value='' style='width:60px;' class='txt4 ' readonly  id='gst_amnt"+i+"' /> </td>";          
   	...
   	data +="<td><input type='text' name='remarks[]' required data-row='"+i+"' value='' style='width:60px;'  class='' id='remarks"+i+"' /> </td>";
