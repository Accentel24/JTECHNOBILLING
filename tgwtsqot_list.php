                                ...
                                <div class="row">
									...
									<!--<a href="addbill.php"><button type="button" class="btn-success btn-sm ">Add New</button></a>-->
                                        ...
                                        <div class="table-header">
                                             Work to beStarted  Quotations List
                                        </div>
...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">   Add New  </button>
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_tgwts_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
...
<?php  
$sql="SELECT distinct store_code FROM add_tgqot";
...
<?php  
$sql="SELECT distinct a.store_name FROM add_tgqot b,dpr a where b.store_code=a.store_code";
  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysqli_error());
while ($row=mysqli_fetch_array($r)) {
...
$start_from = ($page-1) * $results_per_page;
											...
											// $y="select a.store_name,a.city,b.quet_num,b.store_code,b.inv_date,b.id
											 ...
											 $y="select * from add_tgqot where status='work to be started'  and ( quet_num like '%$bsearch%' or falt_no like '%$bsearch%'  or status like '%$bsearch%') order by id desc";
												} else
												...
												/*echo $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id from add_qot a,dpr b where a.quet_num='$qot_nun'
												 ...
												 $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id from add_tgqot a,dpr b where
...
echo "<li><a href='tgwtsqot_list.php?page=".($page-1)."' class='button'>Previous</a></li>"; 

echo "<li><a>".$page."</></li>";

echo "<li><a href='tgwtsqot_list.php?page=".($page+1)."' class='button'>NEXT</a></li>";
echo "</ul>";
?>
