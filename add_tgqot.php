...
xmlhttp.open("GET","get_tsitems.php?q="+str1,true);
xmlhttp.send();
}
</script>	  
            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <?php 
						$a="select `count` as cnt from qutcount where state='TS' ";
 ...
 <input type="hidden" name="id" value="<?php echo $id?>">
  <input type="hidden" name="ses" value="<?php echo $name;?>">
											...
											<tr>
											    ...
											    <td><input  type="text" readonly  class="form-control" value="QJTTG<?php echo $cnt;?>" required name="qt_no" id="qt_no"></td>
...
data +="<td><input type='text' name='amnt[]' data-row='"+i+"' value='' style='width:60px;' readonly class='txt tx6' id='amnt"+i+"' /> </td>";          
 ...
 data +="<td><input type='text' name='serv_amt[]' data-row='"+i+"'  style='width:60px;'  class='' id='serv_amt"+i+"' value='' /> </td>";   
