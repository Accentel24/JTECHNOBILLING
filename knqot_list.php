...
<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_knqot.php'" id="bsearch">   Add New  </button>
		<?php }?>
</div>
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
				  ...
				  <div class="col-sm-2"><b><a href="qut_kn_excel.php" class="btn btn-primary btn-xs">XL Download</a></b></div>
											...
											// $y="select a.store_name,a.city,b.quet_num,b.store_code,b.inv_date,b.id
											 ...
											 $y="select * from add_knqot where quet_num like '%$bsearch%' or falt_no like '%$bsearch%'  or status like '%$bsearch%'order by id desc";
												...
												/*echo $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id from add_qot a,dpr b where a.quet_num='$qot_nun'
												 ...
												 $y="select  a.quet_num,a.store_code,a.inv_date,a.status,a.id,a.ses from add_knqot a,dpr b where
...
$r1=mysqli_fetch_array($ssq1);
                                                        ...
                                                        $qc=mysqli_query($link,"select status from knqot_bill where quet_num='$quetnumc'");
