                    ...
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            <li>
                                ...
                                <a href="#">KN Request Amount List</a>
                            </li>
...
<!--<button class="btn btn-info" type="submit" name="bsearch" onclick="javascript:location.href='add_qot.php'" id="bsearch">
		...
		<form method="post" action="" class="form-horizontal">
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
                  ...
                  <div class="col-sm-2"><b><a href="qut_knamtaprv_excel.php?user=<?php echo $tsname; ?>" class="btn btn-primary btn-xs">XL Download</a></b></div>
				</div>
               ...
               <button class="btn btn-info" type="submit" name="bsearch" id="bsearch">
									...
									if(isset($_POST['bsearch'])){
											 ...
											 $y="select * from knrequest_amnt where  quet_num like '%$bsearch%' or ac_det like '%$bsearch%'  and confirm='Yes' and status!='Amount Transferred' group by ac_det order by id desc";
												} else {
							...
							$qtno=$rs1['quet_num'];
							$krid=$rs1['id'];
						$a="select store_code,ro_no,ro_date,falt_desc,tot_base,tot_ser,tot_gst,adv_amnt,adv_amnt1,adv_amnt2,gst_type,net,bal from add_knqot where quet_num='$qtno'";
							...
							$r3=mysqli_fetch_array($k);
												...
												<tr>
												  ...
												  <td class="hidden-480"><?php 
												   ...
												   <td>
												      <?php
												     $adamt="select sum(approve_amnt) as req_amnt from knrequest_amnt where quet_num='$qtno'and  status='Amount Transferred' and   confirm='Yes'" ;
                                      ...
                                      <td class="hidden-480"><?php 
									 $ac=$rs1['ac_det'];
									 $a="select sum(approve_amnt) as req_amnt from knrequest_amnt where quet_num='$qtno' and id='$krid' and  confirm='Yes' and ac_det='$ac'";
										  ...
										  $r2=mysqli_fetch_array($sr1);
                                            ...
                                            if(($tsname=='admin') or ($tsname=='durgarao') or ($tsname=='accounts')  or ($tsname=='sumanthpotluri')){
											    	$y="select distinct ac_det from knrequest_amnt where confirm='Yes' and status='' ";
											}else{
											    	$y="select distinct ac_det from knrequest_amnt where  user='$tsname' and  confirm='Yes' and status='' ";
											}
										...
										$klt=0;
											while($uy1=mysqli_fetch_array($uy)){
											    ...
											    $mu=mysqli_query($link,"select sum(approve_amnt) as amt from knrequest_amnt where ac_det='$acd' and confirm='Yes' and status='' ");
