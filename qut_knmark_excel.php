...
$objPHPExcel->getActiveSheet()->mergeCells('A1:K1');
 ...
 $objPHPExcel->getActiveSheet()->setCellValue('A4', 'KN  QUOTATION  MARK NOT REQUIRED LIST');
...
header('Content-Disposition: attachment;filename="knmarklist.xlsx"'); //tell browser what's the file name
